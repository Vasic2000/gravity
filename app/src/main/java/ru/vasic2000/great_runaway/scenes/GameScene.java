...
import ru.vasic2000.great_runaway.classes.GameManager;
...
public class GameScene extends SceneFW {
    ...
    private void updateStateGameOver() {
        ...
        if(pCoreFW.getTouchListenerFW().getTuchUp(125, 368, 250, 45)) {
            pCoreFW.setScene(new GameScene(pCoreFW));
        }
        if(pCoreFW.getTouchListenerFW().getTuchUp(125, 438, 200, 45)) {
